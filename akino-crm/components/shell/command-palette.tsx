...
const NAV_COMMANDS: NavCommand[] = [
  ...
  },
  {
    ...
    subtitle: "Pipeline health, velocity, win rate",
    href: "/analytics",
    icon: BarChart3,
    keywords: ["analytics", "reports", "metrics", "stats", "velocity", "conversion", "win rate"],
  },
  {
    id: "nav-enrichment",
  ...
  {
    id: "nav-queue",
    title: "Go to Follow-up Queue",
    subtitle: "Today's tasks, calls, and follow-ups",
    href: "/queue",
    icon: Inbox,
    keywords: ["queue", "inbox", "follow", "followup", "follow-up", "today"],
  },
  {
    id: "nav-tasks",
    title: "Go to Tasks",
  ...
  },
  {
    ...
    subtitle: "Reusable subject & body snippets",
    href: "/settings/templates",
    icon: Settings,
    keywords: ["templates", "email", "snippet", "mustache", "settings"],
  },
  {
    id: "nav-settings",
