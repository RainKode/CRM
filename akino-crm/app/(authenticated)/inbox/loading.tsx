export default function InboxLoading() {
  return (
    <div className="flex h-full overflow-hidden">
      <div className="w-80 shrink-0 border-r border-(--color-border) flex flex-col">
        <div className="h-16 px-4 flex items-center border-b border-(--color-border)">
      ...
      <div className="flex-1 flex flex-col">
        <div className="h-16 border-b border-(--color-border) px-6 flex items-center gap-4">
