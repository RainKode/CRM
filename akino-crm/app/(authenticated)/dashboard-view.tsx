  ...
  return (
    <div className="flex-1 overflow-auto">
      <div className="mx-auto w-full max-w-4xl px-4 md:px-8 py-6 space-y-6">
        ...
        {topFollowUp && (
          <div className="rounded-2xl bg-(--color-surface-1) p-6 sm:p-8 shadow-(--shadow-card-3d) border border-(--color-card-border) transition-all duration-200 hover:shadow-(--shadow-card-3d-hover) hover:-translate-y-0.5">
        ...
        <div className="flex flex-wrap gap-4">
          {/* New */}
          <div className="flex min-w-[140px] flex-1 flex-col justify-between gap-4 rounded-2xl p-6 bg-(--color-surface-2) hover:bg-(--color-surface-3) transition-all duration-200 shadow-(--shadow-card-3d) border border-(--color-card-border) hover:shadow-(--shadow-card-3d-hover) hover:-translate-y-0.5">
          ...
          {/* Won */}
          <div className="flex min-w-[140px] flex-1 flex-col justify-between gap-4 rounded-2xl p-6 bg-(--color-surface-2) hover:bg-(--color-surface-3) transition-all duration-200 relative overflow-hidden shadow-(--shadow-card-3d) border border-(--color-card-border) hover:shadow-(--shadow-card-3d-hover) hover:-translate-y-0.5">
          ...
          {/* Lost */}
          <div className="flex min-w-[140px] flex-1 flex-col justify-between gap-4 rounded-2xl p-6 bg-(--color-surface-2) hover:bg-(--color-surface-3) transition-all duration-200 opacity-70 shadow-(--shadow-card-3d) border border-(--color-card-border) hover:shadow-(--shadow-card-3d-hover) hover:-translate-y-0.5">
            <p className="text-(--color-fg-muted) text-xs font-bold uppercase tracking-wider">
              Lost
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
          {/* Folder Summary */}
          <div className="flex flex-col gap-6 rounded-2xl bg-(--color-surface-1) p-6 sm:p-8 shadow-(--shadow-card-3d) border border-(--color-card-border) transition-all duration-200 hover:shadow-(--shadow-card-3d-hover)">
